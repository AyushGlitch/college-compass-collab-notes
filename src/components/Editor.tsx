...
const Editor: React.FC = () => {
  ...
  const loadContent = async () => {
    const response = await fetch(`/api/loadDocument?creatorId=${creatorId}&roomName=${roomName}`);
    if (response.ok) {
  ...
  return (
    <div>
      ...
      <div className="bg-emerald-200 text-black" ref={editorRef} style={{ height: '300px' }} />
      <div>
